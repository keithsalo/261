...
<img class="screenshot" src="images/hotels_db.jpg" alt="hotels database table screenshot">
<img class="screenshot" src="images/users_db.jpg" alt="users database table screenshot">
